...
export function ProductCartCard({ product }) {
  const { title, discountedPrice, actualPrice, off, path, quantity } = product;

  const { removeFromCart, addToWishList, addToCart, decreaseQuantity } =
    useCartAndWishList();
  return (
    <div className="card__flexrow card__flexrow--lg card__border--black">
      <img src={path} className="image__card--fit" />
      <div className="card--details">
        ...
        <div className="quantity--container">
          ...
          <div className="quantity--btns">
            ...
            <span className="h6__typography">{quantity}</span>
            <button
              className="quantity--btn"
